  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="">Report</li>
        <li class="active">Near Expiry</li>
      </ol>
    </section>
            ...
            <div class="col-xs-12 col-md-12">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Near Expiry Product List</h3>
                  <div class="box-tools">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <?php								
                      $query=mysqli_query($con,"SELECT * FROM stockin natural join `product` natural join category where expiry_status='' and expiry <= DATE_ADD(CURDATE(), INTERVAL 30 DAY)
order by expiry")or die(mysqli_error($con));
                            ...
                            <form role="form" method="POST" action="report_functions.php">
                              <div class="modal-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Price of Product" name="qty" value="<?php echo $row['stockin_qty'];?>">
                                  </div>
                                  <div class="form-group">
                                    <label for="exampleInputEmail1">Expiry Date</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Price of Product" name="price" value="<?php echo date("m/d/Y",strtotime($row['expiry']));?>">
                                  </div>
                                  <div class="form-group">
