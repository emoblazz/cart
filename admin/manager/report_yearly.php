...
<div class="container">
  <br/>
  <h2 class="text-center">Yearly Sales Report for <?php echo $_POST['year'];?>
...
<?php
      $year=$_POST['year'];
      $grand=0;
    $query=mysqli_query($con,"SELECT *,SUM(total) as total from order_details natural join `order` natural join product where DATE_FORMAT(order_date,'%Y')='$year' and payment_status='paid' GROUP BY prod_id ORDER BY prod_name")or die(mysqli_error($con));
